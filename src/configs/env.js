...
export const AUTH_SCOPE =
  import.meta.env.VITE_RSHOP_AUTH_SCOPE?.toString() ??
  "data:read_write,data:delete,project:delete";

export const AUTH_STATE =
  import.meta.env.VITE_RSHOP_AUTH_CODE?.toString() ?? "compass.uol";

export const CLIENT_ID =
  import.meta.env.VITE_RSHOP_CLIENT_ID?.toString() ??
  "c11c6b6e75cf49a191217deef00c3358";

export const CLIENT_SECRET =
  import.meta.env.VITE_RSHOP_CLIENT_SECRET?.toString() ??
